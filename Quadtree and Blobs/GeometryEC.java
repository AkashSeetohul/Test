...
public class Geometry {
	...
	public static boolean circleIntersectsRect(double cx, double cy, double cr, double x1, double y1, double x2, double y2) {
		numCircleRectangleTests++;
		if (cx+cr>=x1 || cx-cr<=x2 || cy-cr<=y2 || cy+cr>=y1) {
			return true;
		}
		else {
			return false;
